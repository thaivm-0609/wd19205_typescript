...
var testUnionArray = [1, true, false, 2];
...
;
//ép kiểu:
var input = 22222; //kiểu dữ liệu bất kỳ
//ép kiểu về string để sử dụng hàm .length
var count1 = input.length; //C1: sử dụng angle-bracket: <kieu-du-lieu>tenBien
var count2 = input.length; //C2: sử dụng từ khóa as (tenBien as kieu-du-lieu)
